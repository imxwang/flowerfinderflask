...
model_path = os.path.join(execution_path, 'interpreter', 'model', 'model4_with_sigmoid.h5')
model = keras.models.load_model(model_path)
folder = os.path.join(execution_path, 'interpreter', 'static', 'crops')
...
def download_and_resize_image(url, new_width=1280, new_height=1280, display=False):
    img_original_path = os.path.join(os.getcwd(), 'interpreter', 'static', 'original')
